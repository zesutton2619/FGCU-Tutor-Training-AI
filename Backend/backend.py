...
class Backend:
    ...
    def generate_response(self, message_body, user_id, name, conversation_name, course):
        """
        ...
        """
        if not self.evaluate_conversation:
        ...
        new_message = self.run_assistant(thread, user_id, name, conversation_name, course)
        print("Current conversation: ", conversation_name)
        print(f"To {name}:", new_message)
        return new_message

    def run_assistant(self, thread, user_id, name, conversation_name, course):
        """
        ...
        if self.evaluate_conversation:
            # assistant_id = 'asst_o7yxIqQhlXqTNQ61l0fiiSBs'
        ...
        if self.evaluate_conversation:
            ...
            additional_instruction = f'The specific course you are in is {course}.'
