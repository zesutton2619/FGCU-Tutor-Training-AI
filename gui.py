...
class DataAnalysisMenu:
    ...
    def view_total_conversations_by_mode(self, mode):
        self.backend.make_total_conversations_by_mode(mode)
        encrypted_plot_image_path = os.path.join(os.getcwd(), f'{self.first_name} Diagrams',
                                                 f'tutors_total_conversations_by_{mode}_plot.enc')
        self.plot_diagram(encrypted_plot_image_path)

    def view_total_conversations_by_tutor(self, tutor):
        self.backend.make_total_conversations_by_tutor(tutor)
        encrypted_plot_image_path = os.path.join(os.getcwd(), f'{self.first_name} Diagrams',
                                                 f'{tutor}_total_conversations_plot.enc')
        self.plot_diagram(encrypted_plot_image_path)
